// Qubrio — Multi-Agent Quantum Compilation Website
...
(function () {
    ...
    const SHARE_TITLE = 'Qubrio: High-Performance Quantum Compilation via Multi-Agent LLM Collaboration';
    const FALLBACK_URL = 'https://anonymous.4open.science/r/Qubrio-486C';
